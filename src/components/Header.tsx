    ...
    <>
      ...
      <header className="w-full md:flex justify-center max-lg:justify-end max-lg:pr-4 pt-6">
        ...
        >
          <a
            href="#aboutme"
            className="block w-max mt-4 border-b-[2.5px] border-cyan-400 tracking-wide hover:text-cyan-400 transition hover:border-b-[2.5px] hover:-translate-y-1 max-my-4"
          >
            Sobre mim
          </a>
          <a
          ...
          <a
            href="#contactMe"
            className="block w-max mt-4 max-md:mb-4 border-b-[2.5px] border-cyan-400 tracking-wide hover:text-cyan-400 transition hover:border-b-[2.5px] hover:-translate-y-1 max-my-4"
          >
            Contato
          </a>
        </nav>
