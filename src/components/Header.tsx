    ...
    <>
      ...
      >
        ...
        >
          <a
            href="#aboutme"
            className="block w-max max-md:mt-4 max-md:border-cyan-400 tracking-wide hover:text-cyan-400 transition hover:-translate-y-1 max-my-4"
          >
            Sobre mim
          </a>
          <a
            href="#technologies"
            className="block w-max max-md:mt-4 max-md:border-cyan-400 tracking-wide hover:text-cyan-400 transition hover hover:-translate-y-1 max-my-4"
          >
            Tecnologias
          </a>
          <a
          ...
          <a
            href="#contactMe"
            className="block w-max max-md:mt-4 max-md:mb-4 max-md:border-cyan-400 tracking-wide hover:text-cyan-400 transition hover:-translate-y-1 max-my-4"
          >
            Contato
          </a>
        </nav>
