    ...
    >
      <div className="flex flex-col gap-12 max-w-xl">
        ...
        <p className="text-gray-100 text-xl leading-relaxed max-lg:text-lg">
          ...
          vamos lá, me chamo Luca e tenho 20 anos, sou 
          formado em Análise e Desenvolvimento de Sistemas. Atuo como Desenvolvedor Fullstack
          com foco nas stacks do Javascript com proeficiência nas seguintes
          tecnologias: React Native e Next.js (React), também possuo conhecimento em Node.js. Sempre fui apaixonado por tecnologia desde pequenino, e o
          ...
          da tecnologia, tornando ele um lugar melhor. Sou movido pela curiosidade e 
          constantemente busco me aprofundar nesse universo, sempre em busca de aprender mais 
          e me atualizar sobre as últimas tendências e avanços na área pelo qual tenho muito carinho. Afinal, provavelmente serei uma 
